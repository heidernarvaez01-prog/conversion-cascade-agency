...
Uso (desde HTML/):  python scripts/make_og.py [slug ...]   (sin argumentos: todos)
Requiere Pillow y la fuente Segoe UI (Windows). Estilo: fondo azul de marca, título grande,
categoría y firma. Se genera solo cuando cambia el título; el resultado se versiona.
"""
import json
import pathlib
import sys
...
if __name__ == "__main__":
    slugs = sys.argv[1:] or json.loads((SRC / "posts.json").read_text(encoding="utf-8"))
    for s in slugs:
        make(s)
